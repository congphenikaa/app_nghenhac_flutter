class AppUrls {
  ...
  static const String baseUrl = 'https://backend-flutter-ten.vercel.app';
  ...
  static const String playSong = '$baseUrl/api/song/play';
  static const String topTrending = '$baseUrl/api/charts/trending';
